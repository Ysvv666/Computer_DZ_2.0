...
vector<RotatedRect> out_blue(Mat img) {
    ...
    Scalar lower1(0, 100, 50);
    Scalar upper1(10, 255, 255);
    Mat mask_b_1;
    inRange(img, lower1, upper1, mask_b_1);

    Scalar lower2(0, 100, 50);
    Scalar upper2(10, 255, 255);
    Mat mask_b_2;
    inRange(img, lower2, upper2, mask_b_2);

    Mat mask_b;
    bitwise_or(mask_b_1, mask_b_2, mask_b);
