...
//          ＼二つ         
  ...
  moveBaseControl.Position_0 = curYuntai_feedback_data.Position_0 + (pred_y );//云台Y轴位置（含速度超前）
  moveBaseControl.Position_1 = curYuntai_feedback_data.Position_1 + (pred_x );//云台X轴位置（含速度超前）
